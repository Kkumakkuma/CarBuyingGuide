"""
CarBuyingGuide Auto Post Generator v2
...
BLOG_NAME = "CarBuyingGuide"
BLOG_NICHE = "automotive"
BLOG_DESCRIPTION = "Expert advice on buying, maintaining, and saving money on your car."

CATEGORIES = [
    "car-buying",     "car-maintenance",     "car-insurance",     "electric-vehicles",
    "used-cars",     "car-finance",     "driving-tips",     "car-reviews",
    "fuel-efficiency",     "car-safety",     "tire-care",     "car-detailing",
    "road-trips",     "car-tech",     "truck-suv",
]

SYSTEM_PROMPT = """You are an expert automotive writer for CarBuyingGuide.
...
- Write as a automotive expert and former dealership manager sharing expertise
