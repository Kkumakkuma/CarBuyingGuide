"""
CarBuyingGuide - Gumroad Promotional Post Generator v2
...
PROMO_PRODUCTS = [
    {
        ...
        "desc": "Track all your car maintenance and never miss an oil change again.",
        "keywords": ["car maintenance", "vehicle service", "oil change schedule", "car upkeep"],
    },
    {
        "name": "Car Purchase Comparison Tool",
        "price": "$7.99",
        "slug": "car-comparison",
        "desc": "Compare cars side by side and make the smartest buying decision.",
        "keywords": ["car comparison", "vehicle buying", "car shopping", "auto purchase"],
    },
]

PROMO_SYSTEM_PROMPT = """You are an expert automotive writer.
