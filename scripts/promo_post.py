"""
CarBuyingGuide - Gumroad Promotional Post Generator
...
PROMO_PRODUCTS = [
    {"name": "Car Maintenance Log", "price": "$6.99", "slug": "car-maintenance", "desc": "Track oil changes, repairs, and costs to make your car last."},
    {"name": "Car Purchase Comparison Tool", "price": "$7.99", "slug": "car-comparison", "desc": "Compare cars side-by-side and calculate true cost of ownership."},
]
